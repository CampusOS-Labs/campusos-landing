  ...
  return (
    <>
      <main className="flex flex-1 flex-col items-center px-4 pt-24 sm:px-6 sm:pt-32">
        ...
        <h1 className="mt-4 max-w-3xl text-center text-display">{manifesto.data.title}</h1>
        <p className="mt-4 max-w-xl text-center text-lead">{manifesto.data.description}</p>
