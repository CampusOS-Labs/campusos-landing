...
export default function ContactPage() {
  return (
    <main className="flex flex-1 flex-col items-center px-4 pt-24 pb-16 sm:px-6 sm:pt-32 sm:pb-24">
      ...
      <h1 className="mt-4 max-w-3xl text-center text-display">Tell us what&apos;s breaking</h1>
      <p className="mt-4 max-w-xl text-center text-lead">We&apos;ll help you fix your school.</p>
